                 ...
                 <asp:ListView runat="server" ID="listUser">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td><%#Eval("role") %></td>
                                        <td>
                                          <asp:LinkButton ID="DelButton" OnClick="DelButton_Click" runat="server" class="btn btn-danger btn-xs delete_button" commandargument='<%#Eval("user_id") %>'><i class="glyphicon glyphicon-trash"></i></asp:LinkButton>
